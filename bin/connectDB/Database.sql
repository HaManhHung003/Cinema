...
CREATE TABLE Ghe (
	...
	FOREIGN KEY (maLichChieu) REFERENCES LichChieuPhim(maLichChieu)
);
...
(N'Nguyễn Hoàng Sơn',N'0987654321', N'Quản lí',1,'2001-01-03',N'067457634523',N'nguyenhoangson@gmail.com',N'Trưa'),
...
INSERT INTO Phim (maPhim, tenPhim,thoiLuongPhim,thoiLuong,theLoai,daoDien,moTa,hinhAnh,banner) VALUES 
(N'P01',	N'MỘ ĐOM ĐÓM',				'01:29:00',	89,		N'Hoạt hình',	N'Takahata Isao',		N'Hai anh em Seita và Setsuko mất mẹ sau cuộc thả bom dữ dội của \n\nkhông quân Mỹ. Cả hai phải vật lộn để tồn tại ở Nhật Bản hậu Thế chiến II. \n\nNhưng xã hội khắc nghiệt và chúng vật lộn tìm kiếm thức ăn cũng như \n\nthoát khỏi những khó khăn giữa chiến tranh.',N'src\\resources\\Image\\banner\\modomdom.png',N'src\\resources\\Image\\modomdom.jpg'),
(N'P02',	N'KUMANTHONG',				'02:01:00',	121,	N'Kinh dị',		N'Xian Lim',			N'Sau cái chết của con trai, Sarah tìm đến vùng đất tâm linh Thái Lan, \n\nkhẩn cần một thầy tu nổi tiếng sử dụng tro cốt đứa bé để tạo nên bức tượng Kumanthong. \n\nBức tượng làm sống lại tình mẫu tử, nhưng triệu hồi những oan hồn ngạ quỷ đến đoạt \n\nxác cả gia đình Sarah.',N'src\\resources\\Image\\banner\\kumathong.png',N'src\\resources\\Image\\kumathong.jpg'),
(N'P03',	N'QUỶ ĂN TẠNG 2',			'02:23:00',	143,	N'Kinh dị',		N'Taweewat Wantha',		N'Ba năm sau cái chết của Yam, Yak vẫn tiếp tục săn lùng linh hồn bí ẩn mặc áo \n\nchoàng đen. Gặp một cô gái có triệu chứng giống Yam, Yak phát hiện ra người bảo vệ linh hồn, \n\npháp sư ẩn dật Puang, sống trong một khu rừng đầy nguy hiểm. Giữa những phép thuật ma \n\nquỷ và những sinh vật nguy hiểm...',N'src\\resources\\Image\\banner\\quyantang2.png',N'src\\resources\\Image\\quyantang.jpg'),
(N'P04',	N'JOKER: FOLIE À DEUX',		'02:03:00',	123,	N'Tâm lý',		N'Todd Phillips',		N'Joker: Folie à Deux\" đưa Arthur Fleck đến trại tâm thần Arkham trong khi chờ xét \n\nxử cho những tội ác của hắn với tư cách là Joker. Trong lúc vật lộn với hai bản ngã của mình, \n\nArthur không chỉ tìm thấy tình yêu đích thực mà còn khám phá ra âm nhạc luôn tồn tại \n\ntrong con người hắn.',N'src\\resources\\Image\\banner\\joker.png',N'src\\resources\\Image\\joker2.jpg'),
(N'P05',	N'CÁM - CHUYỆN CHƯA KỂ ',	'01:41:00',	111,	N'Kinh dị',		N'Trần Hữu Tấn',		N'Câu chuyện phim là dị bản kinh dị đẫm máu lấy cảm hứng từ truyện cổ tích nổi \n\ntiếng Tấm Cám, nội dung chính của phim xoay quanh Cám - em gái cùng cha khác mẹ \n\ncủa Tấm đồng thời sẽ có nhiều nhân vật và chi tiết sáng tạo, gợi cảm giác vừa lạ vừa \n\nquen cho khán giả.',N'src\\resources\\Image\\banner\\cam.png',N'src\\resources\\Image\\cam2.jpg'),
(N'P06',	N'TRANSFORMERS MỘT',		'01:53:00',	113,	N'Hoạt hình',	N'Josh Cooley',			N'Câu chuyện về nguồn gốc chưa từng được hé lộ của Optimus Prime và Megatron. \n\nHai nhân vật được biết đến như những kẻ thù truyền kiếp, nhưng cũng từng là những \n\nngười anh em gắn bó, đã thay đổi vận mệnh của Cybertron mãi mãi.',N'src\\resources\\Image\\banner\\transformer.png',N'src\\resources\\Image\\transformerone.jpg'),
(N'P07',	N'HAI MUỐI',				'01:58:00',	118,	N'Tình cảm',	N'Josh Cooley',			N'Muối – một cô gái mất mẹ từ khi vừa lọt lòng và lớn lên trong tình yêu thương của cha tại vùng đất xã đảo Thiềng Liềng. Bước ngoặt của hai cha con bắt đầu khi Muối trưởng thành, quyết định lên thành phố học tập và làm việc với ước mơ đổi đời để phụ giúp cha.',N'src\\resources\\Image\\banner\\kumathong.png',N'src\\resources\\Image\\modomdom.jpg'),
(N'P08',	N'LOOK BACK',				'00:58:00',	98,		N'Hoạt hình',	N'Kiyotaka Oshiyama',	N'Fujino tự tin thái quá, trong khi Kyomoto lại sống khép kín, cả hai dường như không thể khác biệt hơn, nhưng tình yêu mãnh liệt dành cho manga đã trở thành sợi dây duy nhất kết nối họ. Thế nhưng, một ngày nọ, một biến cố đã xảy ra, khiến thế giới của họ hoàn toàn thay đổi…',N'src\\resources\\Image\\banner\\kumathong.png',N'src\\resources\\Image\\modomdom.jpg'),
(N'P09',	N'ROBOT HOANG DÃ',			'00:58:00',	128,	N'Hoạt hình',	N'Chris Sanders',		N'Cuộc phiêu lưu hoành tráng theo chân hành trình của một robot — đơn vị ROZZUM 7134, gọi tắt là Roz.Roz vô tình dạt vào hoang đảo sau một sự cố và nơi đây trở thành địa điểm sống mới của cô. Tại đây, Roz kết thân và nhận nuôi một chú ngỗng con, đặt tên là Brightbill..',N'src\\resources\\Image\\banner\\kumathong.png',N'src\\resources\\Image\\modomdom.jpg');
...
(N'LC52', N'P02', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim2 * 1, @gioChieuGoc), N'78000', '1'),(N'LC53', N'P02', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim2 * 2, @gioChieuGoc), N'78000', '1'),(N'LC54', N'P02', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim2 * 3, @gioChieuGoc), N'78000', '1'),(N'LC55', N'P02', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim2 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC56', N'P02', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim2 * 5, @gioChieuGoc), N'78000', '1'),(N'LC57', N'P02', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim2 * 6, @gioChieuGoc), N'78000', '1'),(N'LC58', N'P02', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim2 * 7, @gioChieuGoc), N'60000', '1'),(N'LC59', N'P02', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim2 * 8, @gioChieuGoc), N'50000', '1'),(N'LC60', N'P02', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim2 * 9, @gioChieuGoc), N'50000', '1'),
(N'LC61', N'P02', @ngay2, @gioChieuGoc, N'78000', '1'),
(N'LC62', N'P02', @ngay2, DATEADD(MINUTE, @thoiLuongPhim2 * 1, @gioChieuGoc), N'78000', '1'),(N'LC63', N'P02', @ngay2, DATEADD(MINUTE, @thoiLuongPhim2 * 2, @gioChieuGoc), N'78000', '1'),(N'LC64', N'P02', @ngay2, DATEADD(MINUTE, @thoiLuongPhim2 * 3, @gioChieuGoc), N'78000', '1'),(N'LC65', N'P02', @ngay2, DATEADD(MINUTE, @thoiLuongPhim2 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC66', N'P02', @ngay2, DATEADD(MINUTE, @thoiLuongPhim2 * 5, @gioChieuGoc), N'78000', '1'),(N'LC67', N'P02', @ngay2, DATEADD(MINUTE, @thoiLuongPhim2 * 6, @gioChieuGoc), N'78000', '1'),(N'LC68', N'P02', @ngay2, DATEADD(MINUTE, @thoiLuongPhim2 * 7, @gioChieuGoc), N'60000', '1'),(N'LC69', N'P02', @ngay2, DATEADD(MINUTE, @thoiLuongPhim2 * 8, @gioChieuGoc), N'50000', '1'),(N'LC70', N'P02', @ngay2, DATEADD(MINUTE, @thoiLuongPhim2 * 9, @gioChieuGoc), N'50000', '1'),
(N'LC71', N'P02', @ngay3, @gioChieuGoc, N'78000', '1'),
(N'LC72', N'P02', @ngay3, DATEADD(MINUTE, @thoiLuongPhim2 * 1, @gioChieuGoc), N'78000', '1'),(N'LC73', N'P02', @ngay3, DATEADD(MINUTE, @thoiLuongPhim2 * 2, @gioChieuGoc), N'78000', '1'),(N'LC74', N'P02', @ngay3, DATEADD(MINUTE, @thoiLuongPhim2 * 3, @gioChieuGoc), N'78000', '1'),(N'LC75', N'P02', @ngay3, DATEADD(MINUTE, @thoiLuongPhim2 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC76', N'P02', @ngay3, DATEADD(MINUTE, @thoiLuongPhim2 * 5, @gioChieuGoc), N'78000', '1'),(N'LC77', N'P02', @ngay3, DATEADD(MINUTE, @thoiLuongPhim2 * 6, @gioChieuGoc), N'78000', '1'),(N'LC78', N'P02', @ngay3, DATEADD(MINUTE, @thoiLuongPhim2 * 7, @gioChieuGoc), N'60000', '1'),(N'LC79', N'P02', @ngay3, DATEADD(MINUTE, @thoiLuongPhim2 * 8, @gioChieuGoc), N'50000', '1'),(N'LC80', N'P02', @ngay3, DATEADD(MINUTE, @thoiLuongPhim2 * 9, @gioChieuGoc), N'50000', '1'),
(N'LC81', N'P02', @ngay4, @gioChieuGoc, N'78000', '1'),
(N'LC82', N'P02', @ngay4, DATEADD(MINUTE, @thoiLuongPhim2 * 1, @gioChieuGoc), N'78000', '1'),(N'LC83', N'P02', @ngay4, DATEADD(MINUTE, @thoiLuongPhim2 * 2, @gioChieuGoc), N'78000', '1'),(N'LC84', N'P02', @ngay4, DATEADD(MINUTE, @thoiLuongPhim2 * 3, @gioChieuGoc), N'78000', '1'),(N'LC85', N'P02', @ngay4, DATEADD(MINUTE, @thoiLuongPhim2 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC86', N'P02', @ngay4, DATEADD(MINUTE, @thoiLuongPhim2 * 5, @gioChieuGoc), N'78000', '1'),(N'LC87', N'P02', @ngay4, DATEADD(MINUTE, @thoiLuongPhim2 * 6, @gioChieuGoc), N'78000', '1'),(N'LC88', N'P02', @ngay4, DATEADD(MINUTE, @thoiLuongPhim2 * 7, @gioChieuGoc), N'60000', '1'),(N'LC89', N'P02', @ngay4, DATEADD(MINUTE, @thoiLuongPhim2 * 8, @gioChieuGoc), N'50000', '1'),(N'LC90', N'P02', @ngay4, DATEADD(MINUTE, @thoiLuongPhim2 * 9, @gioChieuGoc), N'50000', '1'),
(N'LC91', N'P02', @ngay5, @gioChieuGoc, N'78000', '1'),
(N'LC92', N'P02', @ngay5, DATEADD(MINUTE, @thoiLuongPhim2 * 1, @gioChieuGoc), N'78000', '1'),(N'LC93', N'P02', @ngay5, DATEADD(MINUTE, @thoiLuongPhim2 * 2, @gioChieuGoc), N'78000', '1'),(N'LC94', N'P02', @ngay5, DATEADD(MINUTE, @thoiLuongPhim2 * 3, @gioChieuGoc), N'78000', '1'),(N'LC95', N'P02', @ngay5, DATEADD(MINUTE, @thoiLuongPhim2 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC96', N'P02', @ngay5, DATEADD(MINUTE, @thoiLuongPhim2 * 5, @gioChieuGoc), N'78000', '1'),(N'LC97', N'P02', @ngay5, DATEADD(MINUTE, @thoiLuongPhim2 * 6, @gioChieuGoc), N'78000', '1'),(N'LC98', N'P02', @ngay5, DATEADD(MINUTE, @thoiLuongPhim2 * 7, @gioChieuGoc), N'60000', '1'),(N'LC99', N'P02', @ngay5, DATEADD(MINUTE, @thoiLuongPhim2 * 8, @gioChieuGoc), N'50000', '1'),(N'LC100', N'P02', @ngay5, DATEADD(MINUTE, @thoiLuongPhim2 * 9, @gioChieuGoc), N'50000', '1'),
--Phim3
(N'LC101', N'P03', @ngayHienTai, @gioChieuGoc, N'78000', '1'),
(N'LC102', N'P03', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim3 * 1, @gioChieuGoc), N'78000', '1'),(N'LC103', N'P03', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim3 * 2, @gioChieuGoc), N'78000', '1'),(N'LC104', N'P03', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim3 * 3, @gioChieuGoc), N'78000', '1'),(N'LC105', N'P03', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim3 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC106', N'P03', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim3 * 5, @gioChieuGoc), N'78000', '1'),(N'LC107', N'P03', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim3 * 6, @gioChieuGoc), N'78000', '1'),(N'LC108', N'P03', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim3 * 7, @gioChieuGoc), N'60000', '1'),(N'LC109', N'P03', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim3 * 8, @gioChieuGoc), N'50000', '1'),(N'LC110', N'P03', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim3 * 9, @gioChieuGoc), N'50000', '1'),
(N'LC111', N'P03', @ngay2, @gioChieuGoc, N'78000', '1'),
(N'LC112', N'P03', @ngay2, DATEADD(MINUTE, @thoiLuongPhim3 * 1, @gioChieuGoc), N'78000', '1'),(N'LC113', N'P03', @ngay2, DATEADD(MINUTE, @thoiLuongPhim3 * 2, @gioChieuGoc), N'78000', '1'),(N'LC114', N'P03', @ngay2, DATEADD(MINUTE, @thoiLuongPhim3 * 3, @gioChieuGoc), N'78000', '1'),(N'LC115', N'P03', @ngay2, DATEADD(MINUTE, @thoiLuongPhim3 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC116', N'P03', @ngay2, DATEADD(MINUTE, @thoiLuongPhim3 * 5, @gioChieuGoc), N'78000', '1'),(N'LC117', N'P03', @ngay2, DATEADD(MINUTE, @thoiLuongPhim3 * 6, @gioChieuGoc), N'78000', '1'),(N'LC118', N'P03', @ngay2, DATEADD(MINUTE, @thoiLuongPhim3 * 7, @gioChieuGoc), N'60000', '1'),(N'LC119', N'P03', @ngay2, DATEADD(MINUTE, @thoiLuongPhim3 * 8, @gioChieuGoc), N'50000', '1'),(N'LC120', N'P03', @ngay2, DATEADD(MINUTE, @thoiLuongPhim3 * 9, @gioChieuGoc), N'50000', '1'),
(N'LC121', N'P03', @ngay3, @gioChieuGoc, N'78000', '1'),
(N'LC122', N'P03', @ngay3, DATEADD(MINUTE, @thoiLuongPhim3 * 1, @gioChieuGoc), N'78000', '1'),(N'LC123', N'P03', @ngay3, DATEADD(MINUTE, @thoiLuongPhim3 * 2, @gioChieuGoc), N'78000', '1'),(N'LC124', N'P03', @ngay3, DATEADD(MINUTE, @thoiLuongPhim3 * 3, @gioChieuGoc), N'78000', '1'),(N'LC125', N'P03', @ngay3, DATEADD(MINUTE, @thoiLuongPhim3 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC126', N'P03', @ngay3, DATEADD(MINUTE, @thoiLuongPhim3 * 5, @gioChieuGoc), N'78000', '1'),(N'LC127', N'P03', @ngay3, DATEADD(MINUTE, @thoiLuongPhim3 * 6, @gioChieuGoc), N'78000', '1'),(N'LC128', N'P03', @ngay3, DATEADD(MINUTE, @thoiLuongPhim3 * 7, @gioChieuGoc), N'60000', '1'),(N'LC129', N'P03', @ngay3, DATEADD(MINUTE, @thoiLuongPhim3 * 8, @gioChieuGoc), N'50000', '1'),(N'LC130', N'P03', @ngay3, DATEADD(MINUTE, @thoiLuongPhim3 * 9, @gioChieuGoc), N'50000', '1'),
(N'LC131', N'P03', @ngay4, @gioChieuGoc, N'78000', '1'),
(N'LC132', N'P03', @ngay4, DATEADD(MINUTE, @thoiLuongPhim3 * 1, @gioChieuGoc), N'78000', '1'),(N'LC133', N'P03', @ngay4, DATEADD(MINUTE, @thoiLuongPhim3 * 2, @gioChieuGoc), N'78000', '1'),(N'LC134', N'P03', @ngay4, DATEADD(MINUTE, @thoiLuongPhim3 * 3, @gioChieuGoc), N'78000', '1'),(N'LC135', N'P03', @ngay4, DATEADD(MINUTE, @thoiLuongPhim3 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC136', N'P03', @ngay4, DATEADD(MINUTE, @thoiLuongPhim3 * 5, @gioChieuGoc), N'78000', '1'),(N'LC137', N'P03', @ngay4, DATEADD(MINUTE, @thoiLuongPhim3 * 6, @gioChieuGoc), N'78000', '1'),(N'LC138', N'P03', @ngay4, DATEADD(MINUTE, @thoiLuongPhim3 * 7, @gioChieuGoc), N'60000', '1'),(N'LC139', N'P03', @ngay4, DATEADD(MINUTE, @thoiLuongPhim3 * 8, @gioChieuGoc), N'50000', '1'),(N'LC140', N'P03', @ngay4, DATEADD(MINUTE, @thoiLuongPhim3 * 9, @gioChieuGoc), N'50000', '1'),
(N'LC141', N'P03', @ngay5, @gioChieuGoc, N'78000', '1'),
(N'LC142', N'P03', @ngay5, DATEADD(MINUTE, @thoiLuongPhim3 * 1, @gioChieuGoc), N'78000', '1'),(N'LC143', N'P03', @ngay5, DATEADD(MINUTE, @thoiLuongPhim3 * 2, @gioChieuGoc), N'78000', '1'),(N'LC144', N'P03', @ngay5, DATEADD(MINUTE, @thoiLuongPhim3 * 3, @gioChieuGoc), N'78000', '1'),(N'LC145', N'P03', @ngay5, DATEADD(MINUTE, @thoiLuongPhim3 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC146', N'P03', @ngay5, DATEADD(MINUTE, @thoiLuongPhim3 * 5, @gioChieuGoc), N'78000', '1'),(N'LC147', N'P03', @ngay5, DATEADD(MINUTE, @thoiLuongPhim3 * 6, @gioChieuGoc), N'78000', '1'),(N'LC148', N'P03', @ngay5, DATEADD(MINUTE, @thoiLuongPhim3 * 7, @gioChieuGoc), N'60000', '1'),(N'LC149', N'P03', @ngay5, DATEADD(MINUTE, @thoiLuongPhim3 * 8, @gioChieuGoc), N'50000', '1'),(N'LC150', N'P03', @ngay5, DATEADD(MINUTE, @thoiLuongPhim3 * 9, @gioChieuGoc), N'50000', '1'),
--Phim4
(N'LC151', N'P04', @ngayHienTai, @gioChieuGoc, N'78000', '1'),
(N'LC152', N'P04', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim4 * 1, @gioChieuGoc), N'78000', '1'),(N'LC153', N'P04', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim4 * 2, @gioChieuGoc), N'78000', '1'),(N'LC154', N'P04', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim4 * 3, @gioChieuGoc), N'78000', '1'),(N'LC155', N'P04', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim4 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC156', N'P04', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim4 * 5, @gioChieuGoc), N'78000', '1'),(N'LC157', N'P04', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim4 * 6, @gioChieuGoc), N'78000', '1'),(N'LC158', N'P04', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim4 * 7, @gioChieuGoc), N'60000', '1'),(N'LC159', N'P04', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim4 * 8, @gioChieuGoc), N'50000', '1'),(N'LC160', N'P04', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim4 * 9, @gioChieuGoc), N'50000', '1'),
(N'LC161', N'P04', @ngay2, @gioChieuGoc, N'78000', '1'),
(N'LC162', N'P04', @ngay2, DATEADD(MINUTE, @thoiLuongPhim4 * 1, @gioChieuGoc), N'78000', '1'),(N'LC163', N'P04', @ngay2, DATEADD(MINUTE, @thoiLuongPhim4 * 2, @gioChieuGoc), N'78000', '1'),(N'LC164', N'P04', @ngay2, DATEADD(MINUTE, @thoiLuongPhim4 * 3, @gioChieuGoc), N'78000', '1'),(N'LC165', N'P04', @ngay2, DATEADD(MINUTE, @thoiLuongPhim4 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC166', N'P04', @ngay2, DATEADD(MINUTE, @thoiLuongPhim4 * 5, @gioChieuGoc), N'78000', '1'),(N'LC167', N'P04', @ngay2, DATEADD(MINUTE, @thoiLuongPhim4 * 6, @gioChieuGoc), N'78000', '1'),(N'LC168', N'P04', @ngay2, DATEADD(MINUTE, @thoiLuongPhim4 * 7, @gioChieuGoc), N'60000', '1'),(N'LC169', N'P04', @ngay2, DATEADD(MINUTE, @thoiLuongPhim4 * 8, @gioChieuGoc), N'50000', '1'),(N'LC170', N'P04', @ngay2, DATEADD(MINUTE, @thoiLuongPhim4 * 9, @gioChieuGoc), N'50000', '1'),
(N'LC171', N'P04', @ngay3, @gioChieuGoc, N'78000', '1'),
(N'LC172', N'P04', @ngay3, DATEADD(MINUTE, @thoiLuongPhim4 * 1, @gioChieuGoc), N'78000', '1'),(N'LC173', N'P04', @ngay3, DATEADD(MINUTE, @thoiLuongPhim4 * 2, @gioChieuGoc), N'78000', '1'),(N'LC174', N'P04', @ngay3, DATEADD(MINUTE, @thoiLuongPhim4 * 3, @gioChieuGoc), N'78000', '1'),(N'LC175', N'P04', @ngay3, DATEADD(MINUTE, @thoiLuongPhim4 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC176', N'P04', @ngay3, DATEADD(MINUTE, @thoiLuongPhim4 * 5, @gioChieuGoc), N'78000', '1'),(N'LC177', N'P04', @ngay3, DATEADD(MINUTE, @thoiLuongPhim4 * 6, @gioChieuGoc), N'78000', '1'),(N'LC178', N'P04', @ngay3, DATEADD(MINUTE, @thoiLuongPhim4 * 7, @gioChieuGoc), N'60000', '1'),(N'LC179', N'P04', @ngay3, DATEADD(MINUTE, @thoiLuongPhim4 * 8, @gioChieuGoc), N'50000', '1'),(N'LC180', N'P04', @ngay3, DATEADD(MINUTE, @thoiLuongPhim4 * 9, @gioChieuGoc), N'50000', '1'),
(N'LC181', N'P04', @ngay4, @gioChieuGoc, N'78000', '1'),
(N'LC182', N'P04', @ngay4, DATEADD(MINUTE, @thoiLuongPhim4 * 1, @gioChieuGoc), N'78000', '1'),(N'LC183', N'P04', @ngay4, DATEADD(MINUTE, @thoiLuongPhim4 * 2, @gioChieuGoc), N'78000', '1'),(N'LC184', N'P04', @ngay4, DATEADD(MINUTE, @thoiLuongPhim4 * 3, @gioChieuGoc), N'78000', '1'),(N'LC185', N'P04', @ngay4, DATEADD(MINUTE, @thoiLuongPhim4 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC186', N'P04', @ngay4, DATEADD(MINUTE, @thoiLuongPhim4 * 5, @gioChieuGoc), N'78000', '1'),(N'LC187', N'P04', @ngay4, DATEADD(MINUTE, @thoiLuongPhim4 * 6, @gioChieuGoc), N'78000', '1'),(N'LC188', N'P04', @ngay4, DATEADD(MINUTE, @thoiLuongPhim4 * 7, @gioChieuGoc), N'60000', '1'),(N'LC189', N'P04', @ngay4, DATEADD(MINUTE, @thoiLuongPhim4 * 8, @gioChieuGoc), N'50000', '1'),(N'LC190', N'P04', @ngay4, DATEADD(MINUTE, @thoiLuongPhim4 * 9, @gioChieuGoc), N'50000', '1'),
(N'LC191', N'P04', @ngay5, @gioChieuGoc, N'78000', '1'),
(N'LC192', N'P04', @ngay5, DATEADD(MINUTE, @thoiLuongPhim4 * 1, @gioChieuGoc), N'78000', '1'),(N'LC193', N'P04', @ngay5, DATEADD(MINUTE, @thoiLuongPhim4 * 2, @gioChieuGoc), N'78000', '1'),(N'LC194', N'P04', @ngay5, DATEADD(MINUTE, @thoiLuongPhim4 * 3, @gioChieuGoc), N'78000', '1'),(N'LC195', N'P04', @ngay5, DATEADD(MINUTE, @thoiLuongPhim4 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC196', N'P04', @ngay5, DATEADD(MINUTE, @thoiLuongPhim4 * 5, @gioChieuGoc), N'78000', '1'),(N'LC197', N'P04', @ngay5, DATEADD(MINUTE, @thoiLuongPhim4 * 6, @gioChieuGoc), N'78000', '1'),(N'LC198', N'P04', @ngay5, DATEADD(MINUTE, @thoiLuongPhim4 * 7, @gioChieuGoc), N'60000', '1'),(N'LC199', N'P04', @ngay5, DATEADD(MINUTE, @thoiLuongPhim4 * 8, @gioChieuGoc), N'50000', '1'),(N'LC200', N'P04', @ngay5, DATEADD(MINUTE, @thoiLuongPhim4 * 9, @gioChieuGoc), N'50000', '1'),
--Phim5
(N'LC201', N'P05', @ngayHienTai, @gioChieuGoc, N'78000', '1'),
(N'LC202', N'P05', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim5 * 1, @gioChieuGoc), N'78000', '1'),(N'LC203', N'P05', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim5 * 2, @gioChieuGoc), N'78000', '1'),(N'LC204', N'P05', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim5 * 3, @gioChieuGoc), N'78000', '1'),(N'LC205', N'P05', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim5 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC206', N'P05', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim5 * 5, @gioChieuGoc), N'78000', '1'),(N'LC207', N'P05', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim5 * 6, @gioChieuGoc), N'78000', '1'),(N'LC208', N'P05', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim5 * 7, @gioChieuGoc), N'60000', '1'),(N'LC209', N'P05', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim5 * 8, @gioChieuGoc), N'50000', '1'),(N'LC210', N'P05', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim5 * 9, @gioChieuGoc), N'50000', '1'),
(N'LC211', N'P05', @ngay2, @gioChieuGoc, N'78000', '1'),
(N'LC212', N'P05', @ngay2, DATEADD(MINUTE, @thoiLuongPhim5 * 1, @gioChieuGoc), N'78000', '1'),(N'LC213', N'P05', @ngay2, DATEADD(MINUTE, @thoiLuongPhim5 * 2, @gioChieuGoc), N'78000', '1'),(N'LC214', N'P05', @ngay2, DATEADD(MINUTE, @thoiLuongPhim5 * 3, @gioChieuGoc), N'78000', '1'),(N'LC215', N'P05', @ngay2, DATEADD(MINUTE, @thoiLuongPhim5 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC216', N'P05', @ngay2, DATEADD(MINUTE, @thoiLuongPhim5 * 5, @gioChieuGoc), N'78000', '1'),(N'LC217', N'P05', @ngay2, DATEADD(MINUTE, @thoiLuongPhim5 * 6, @gioChieuGoc), N'78000', '1'),(N'LC218', N'P05', @ngay2, DATEADD(MINUTE, @thoiLuongPhim5 * 7, @gioChieuGoc), N'60000', '1'),(N'LC219', N'P05', @ngay2, DATEADD(MINUTE, @thoiLuongPhim5 * 8, @gioChieuGoc), N'50000', '1'),(N'LC220', N'P05', @ngay2, DATEADD(MINUTE, @thoiLuongPhim5 * 9, @gioChieuGoc), N'50000', '1'),
(N'LC221', N'P05', @ngay3, @gioChieuGoc, N'78000', '1'),
(N'LC222', N'P05', @ngay3, DATEADD(MINUTE, @thoiLuongPhim5 * 1, @gioChieuGoc), N'78000', '1'),(N'LC223', N'P05', @ngay3, DATEADD(MINUTE, @thoiLuongPhim5 * 2, @gioChieuGoc), N'78000', '1'),(N'LC224', N'P05', @ngay3, DATEADD(MINUTE, @thoiLuongPhim5 * 3, @gioChieuGoc), N'78000', '1'),(N'LC225', N'P05', @ngay3, DATEADD(MINUTE, @thoiLuongPhim5 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC226', N'P05', @ngay3, DATEADD(MINUTE, @thoiLuongPhim5 * 5, @gioChieuGoc), N'78000', '1'),(N'LC227', N'P05', @ngay3, DATEADD(MINUTE, @thoiLuongPhim5 * 6, @gioChieuGoc), N'78000', '1'),(N'LC228', N'P05', @ngay3, DATEADD(MINUTE, @thoiLuongPhim5 * 7, @gioChieuGoc), N'60000', '1'),(N'LC229', N'P05', @ngay3, DATEADD(MINUTE, @thoiLuongPhim5 * 8, @gioChieuGoc), N'50000', '1'),(N'LC230', N'P05', @ngay3, DATEADD(MINUTE, @thoiLuongPhim5 * 9, @gioChieuGoc), N'50000', '1'),
(N'LC231', N'P05', @ngay4, @gioChieuGoc, N'78000', '1'),
(N'LC232', N'P05', @ngay4, DATEADD(MINUTE, @thoiLuongPhim5 * 1, @gioChieuGoc), N'78000', '1'),(N'LC233', N'P05', @ngay4, DATEADD(MINUTE, @thoiLuongPhim5 * 2, @gioChieuGoc), N'78000', '1'),(N'LC234', N'P05', @ngay4, DATEADD(MINUTE, @thoiLuongPhim5 * 3, @gioChieuGoc), N'78000', '1'),(N'LC235', N'P05', @ngay4, DATEADD(MINUTE, @thoiLuongPhim5 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC236', N'P05', @ngay4, DATEADD(MINUTE, @thoiLuongPhim5 * 5, @gioChieuGoc), N'78000', '1'),(N'LC237', N'P05', @ngay4, DATEADD(MINUTE, @thoiLuongPhim5 * 6, @gioChieuGoc), N'78000', '1'),(N'LC238', N'P05', @ngay4, DATEADD(MINUTE, @thoiLuongPhim5 * 7, @gioChieuGoc), N'60000', '1'),(N'LC239', N'P05', @ngay4, DATEADD(MINUTE, @thoiLuongPhim5 * 8, @gioChieuGoc), N'50000', '1'),(N'LC240', N'P05', @ngay4, DATEADD(MINUTE, @thoiLuongPhim5 * 9, @gioChieuGoc), N'50000', '1'),
(N'LC241', N'P05', @ngay5, @gioChieuGoc, N'78000', '1'),
(N'LC242', N'P05', @ngay5, DATEADD(MINUTE, @thoiLuongPhim5 * 1, @gioChieuGoc), N'78000', '1'),(N'LC243', N'P05', @ngay5, DATEADD(MINUTE, @thoiLuongPhim5 * 2, @gioChieuGoc), N'78000', '1'),(N'LC244', N'P05', @ngay5, DATEADD(MINUTE, @thoiLuongPhim5 * 3, @gioChieuGoc), N'78000', '1'),(N'LC245', N'P05', @ngay5, DATEADD(MINUTE, @thoiLuongPhim5 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC246', N'P05', @ngay5, DATEADD(MINUTE, @thoiLuongPhim5 * 5, @gioChieuGoc), N'78000', '1'),(N'LC247', N'P05', @ngay5, DATEADD(MINUTE, @thoiLuongPhim5 * 6, @gioChieuGoc), N'78000', '1'),(N'LC248', N'P05', @ngay5, DATEADD(MINUTE, @thoiLuongPhim5 * 7, @gioChieuGoc), N'60000', '1'),(N'LC249', N'P05', @ngay5, DATEADD(MINUTE, @thoiLuongPhim5 * 8, @gioChieuGoc), N'50000', '1'),(N'LC250', N'P05', @ngay5, DATEADD(MINUTE, @thoiLuongPhim5 * 9, @gioChieuGoc), N'50000', '1'),
--Phim6
(N'LC251', N'P06', @ngayHienTai, @gioChieuGoc, N'78000', '1'),
(N'LC252', N'P06', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim6 * 1, @gioChieuGoc), N'78000', '1'),(N'LC253', N'P06', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim6 * 2, @gioChieuGoc), N'78000', '1'),(N'LC254', N'P06', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim6 * 3, @gioChieuGoc), N'78000', '1'),(N'LC255', N'P06', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim6 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC256', N'P06', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim6 * 5, @gioChieuGoc), N'78000', '1'),(N'LC257', N'P06', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim6 * 6, @gioChieuGoc), N'78000', '1'),(N'LC258', N'P06', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim6 * 7, @gioChieuGoc), N'60000', '1'),(N'LC259', N'P06', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim6 * 8, @gioChieuGoc), N'50000', '1'),(N'LC260', N'P06', @ngayHienTai, DATEADD(MINUTE, @thoiLuongPhim6 * 9, @gioChieuGoc), N'50000', '1'),
(N'LC261', N'P06', @ngay2, @gioChieuGoc, N'78000', '1'),
(N'LC262', N'P06', @ngay2, DATEADD(MINUTE, @thoiLuongPhim6 * 1, @gioChieuGoc), N'78000', '1'),(N'LC263', N'P06', @ngay2, DATEADD(MINUTE, @thoiLuongPhim6 * 2, @gioChieuGoc), N'78000', '1'),(N'LC264', N'P06', @ngay2, DATEADD(MINUTE, @thoiLuongPhim6 * 3, @gioChieuGoc), N'78000', '1'),(N'LC265', N'P06', @ngay2, DATEADD(MINUTE, @thoiLuongPhim6 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC266', N'P06', @ngay2, DATEADD(MINUTE, @thoiLuongPhim6 * 5, @gioChieuGoc), N'78000', '1'),(N'LC267', N'P06', @ngay2, DATEADD(MINUTE, @thoiLuongPhim6 * 6, @gioChieuGoc), N'78000', '1'),(N'LC268', N'P06', @ngay2, DATEADD(MINUTE, @thoiLuongPhim6 * 7, @gioChieuGoc), N'60000', '1'),(N'LC269', N'P06', @ngay2, DATEADD(MINUTE, @thoiLuongPhim6 * 8, @gioChieuGoc), N'50000', '1'),(N'LC270', N'P06', @ngay2, DATEADD(MINUTE, @thoiLuongPhim6 * 9, @gioChieuGoc), N'50000', '1'),
(N'LC271', N'P06', @ngay3, @gioChieuGoc, N'78000', '1'),
(N'LC272', N'P06', @ngay3, DATEADD(MINUTE, @thoiLuongPhim6 * 1, @gioChieuGoc), N'78000', '1'),(N'LC273', N'P06', @ngay3, DATEADD(MINUTE, @thoiLuongPhim6 * 2, @gioChieuGoc), N'78000', '1'),(N'LC274', N'P06', @ngay3, DATEADD(MINUTE, @thoiLuongPhim6 * 3, @gioChieuGoc), N'78000', '1'),(N'LC275', N'P06', @ngay3, DATEADD(MINUTE, @thoiLuongPhim6 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC276', N'P06', @ngay3, DATEADD(MINUTE, @thoiLuongPhim6 * 5, @gioChieuGoc), N'78000', '1'),(N'LC277', N'P06', @ngay3, DATEADD(MINUTE, @thoiLuongPhim6 * 6, @gioChieuGoc), N'78000', '1'),(N'LC278', N'P06', @ngay3, DATEADD(MINUTE, @thoiLuongPhim6 * 7, @gioChieuGoc), N'60000', '1'),(N'LC279', N'P06', @ngay3, DATEADD(MINUTE, @thoiLuongPhim6 * 8, @gioChieuGoc), N'50000', '1'),(N'LC280', N'P06', @ngay3, DATEADD(MINUTE, @thoiLuongPhim6 * 9, @gioChieuGoc), N'50000', '1'),
(N'LC281', N'P06', @ngay4, @gioChieuGoc, N'78000', '1'),
(N'LC282', N'P06', @ngay4, DATEADD(MINUTE, @thoiLuongPhim6 * 1, @gioChieuGoc), N'78000', '1'),(N'LC283', N'P06', @ngay4, DATEADD(MINUTE, @thoiLuongPhim6 * 2, @gioChieuGoc), N'78000', '1'),(N'LC284', N'P06', @ngay4, DATEADD(MINUTE, @thoiLuongPhim6 * 3, @gioChieuGoc), N'78000', '1'),(N'LC285', N'P06', @ngay4, DATEADD(MINUTE, @thoiLuongPhim6 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC286', N'P06', @ngay4, DATEADD(MINUTE, @thoiLuongPhim6 * 5, @gioChieuGoc), N'78000', '1'),(N'LC287', N'P06', @ngay4, DATEADD(MINUTE, @thoiLuongPhim6 * 6, @gioChieuGoc), N'78000', '1'),(N'LC288', N'P06', @ngay4, DATEADD(MINUTE, @thoiLuongPhim6 * 7, @gioChieuGoc), N'60000', '1'),(N'LC289', N'P06', @ngay4, DATEADD(MINUTE, @thoiLuongPhim6 * 8, @gioChieuGoc), N'50000', '1'),(N'LC290', N'P06', @ngay4, DATEADD(MINUTE, @thoiLuongPhim6 * 9, @gioChieuGoc), N'50000', '1'),
(N'LC291', N'P06', @ngay5, @gioChieuGoc, N'78000', '1'),
(N'LC292', N'P06', @ngay5, DATEADD(MINUTE, @thoiLuongPhim6 * 1, @gioChieuGoc), N'78000', '1'),(N'LC293', N'P06', @ngay5, DATEADD(MINUTE, @thoiLuongPhim6 * 2, @gioChieuGoc), N'78000', '1'),(N'LC294', N'P06', @ngay5, DATEADD(MINUTE, @thoiLuongPhim6 * 3, @gioChieuGoc), N'78000', '1'),(N'LC295', N'P06', @ngay5, DATEADD(MINUTE, @thoiLuongPhim6 * 4, @gioChieuGoc), N'78000', '1'),
(N'LC296', N'P06', @ngay5, DATEADD(MINUTE, @thoiLuongPhim6 * 5, @gioChieuGoc), N'78000', '1'),(N'LC297', N'P06', @ngay5, DATEADD(MINUTE, @thoiLuongPhim6 * 6, @gioChieuGoc), N'78000', '1'),(N'LC298', N'P06', @ngay5, DATEADD(MINUTE, @thoiLuongPhim6 * 7, @gioChieuGoc), N'60000', '1'),(N'LC299', N'P06', @ngay5, DATEADD(MINUTE, @thoiLuongPhim6 * 8, @gioChieuGoc), N'50000', '1'),(N'LC300', N'P06', @ngay5, DATEADD(MINUTE, @thoiLuongPhim6 * 9, @gioChieuGoc), N'50000', '1');
...
(N'MGG03',N'RA MẮT LY MỚI MÙA HALLOWEEN!',N'50',N'2024-10-07', N'2024-10-12','Hang thanh vien > Bach Kim\nA',N'src');


INSERT INTO Ghe (maGhe, loaiGhe,viTri, giaGhe, maPhong, trangThai,maLichChieu) VALUES 
--Phong01
(N'G01', N'Đơn', N'A01', 0, N'P01', 1,N'LC01'), 
(N'G02', N'Đơn', N'A02', 0, N'P01', 1,N'LC01'), 
(N'G03', N'Đơn', N'A03', 0, N'P01', 1,N'LC01'),
(N'G04', N'Đơn', N'A04', 0, N'P01', 1,N'LC01'), 
(N'G05', N'Đơn', N'A05', 0, N'P01', 1,N'LC01'), 
(N'G06', N'Đơn', N'A06', 0, N'P01', 1,N'LC01'),
(N'G07', N'Đơn', N'A07', 0, N'P01', 1,N'LC01'), 
(N'G08', N'Đơn', N'A08', 0, N'P01', 1,N'LC01'), 
(N'G09', N'Đơn', N'A09', 0, N'P01', 1,N'LC01'),
(N'G10', N'Đơn', N'A10', 0, N'P01', 1,N'LC01'), 
(N'G11', N'Đơn', N'A11', 0, N'P01', 1,N'LC01'),
(N'G12', N'Đơn', N'B01', 0, N'P01', 1,N'LC01'), 
(N'G13', N'Đơn', N'B02', 0, N'P01', 1,N'LC01'), 
(N'G14', N'Đơn', N'B03', 0, N'P01', 1,N'LC01'),
(N'G15', N'Đơn', N'B04', 0, N'P01', 1,N'LC01'), 
(N'G16', N'Đơn', N'B05', 0, N'P01', 1,N'LC01'), 
(N'G17', N'Đơn', N'B06', 0, N'P01', 1,N'LC01'),
(N'G18', N'Đơn', N'B07', 0, N'P01', 1,N'LC01'), 
(N'G19', N'Đơn', N'B08', 0, N'P01', 1,N'LC01'), 
(N'G20', N'Đơn', N'B09', 0, N'P01', 1,N'LC01'),
(N'G21', N'Đơn', N'B10', 0, N'P01', 1,N'LC01'), 
(N'G22', N'Đơn', N'B11', 0, N'P01', 1,N'LC01'),
(N'G23', N'Đơn', N'C01', 0, N'P01', 1,N'LC01'), 
(N'G24', N'Đơn', N'C02', 0, N'P01', 1,N'LC01'), 
(N'G25', N'Đơn', N'C03', 0, N'P01', 1,N'LC01'),
(N'G26', N'Đơn', N'C04', 0, N'P01', 1,N'LC01'), 
(N'G27', N'Đơn', N'C05', 0, N'P01', 1,N'LC01'), 
(N'G28', N'Đơn', N'C06', 0, N'P01', 1,N'LC01'),
(N'G29', N'Đơn', N'C07', 0, N'P01', 1,N'LC01'), 
(N'G30', N'Đơn', N'C08', 0, N'P01', 1,N'LC01'), 
(N'G31', N'Đơn', N'C09', 0, N'P01', 1,N'LC01'),
(N'G32', N'Đơn', N'C10', 0, N'P01', 1,N'LC01'), 
(N'G33', N'Đơn', N'C11', 0, N'P01', 1,N'LC01'),
(N'G34', N'Đơn', N'D01', 0, N'P01', 1,N'LC01'), 
(N'G35', N'Đơn', N'D02', 0, N'P01', 1,N'LC01'), 
(N'G36', N'Đơn', N'D03', 0, N'P01', 1,N'LC01'),
(N'G37', N'Đơn', N'D04', 0, N'P01', 1,N'LC01'), 
(N'G38', N'Đơn', N'D05', 0, N'P01', 1,N'LC01'), 
(N'G39', N'Đơn', N'D06', 0, N'P01', 1,N'LC01'),
(N'G40', N'Đơn', N'D07', 0, N'P01', 1,N'LC01'), 
(N'G41', N'Đơn', N'D08', 0, N'P01', 1,N'LC01'), 
(N'G42', N'Đơn', N'D09', 0, N'P01', 1,N'LC01'),
(N'G43', N'Đơn', N'D10', 0, N'P01', 1,N'LC01'), 
(N'G44', N'Đơn', N'D11', 0, N'P01', 1,N'LC01'),
(N'G45', N'Đơn', N'E01', 0, N'P01', 1,N'LC01'), 
(N'G46', N'Đơn', N'E02', 0, N'P01', 1,N'LC01'), 
(N'G47', N'Đơn', N'E03', 0, N'P01', 1,N'LC01'),
(N'G48', N'Đơn', N'E04', 0, N'P01', 1,N'LC01'), 
(N'G49', N'Đơn', N'E05', 0, N'P01', 1,N'LC01'), 
(N'G50', N'Đơn', N'E06', 0, N'P01', 1,N'LC01'),
(N'G51', N'Đơn', N'E07', 0, N'P01', 1,N'LC01'), 
(N'G52', N'Đơn', N'E08', 0, N'P01', 1,N'LC01'), 
(N'G53', N'Đơn', N'E09', 0, N'P01', 1,N'LC01'),
(N'G54', N'Đơn', N'E10', 0, N'P01', 1,N'LC01'), 
(N'G55', N'Đơn', N'E11', 0, N'P01', 1,N'LC01'),
(N'G56', N'Đơn', N'F01', 0, N'P01', 1,N'LC01'), 
(N'G57', N'Đơn', N'F02', 0, N'P01', 1,N'LC01'), 
(N'G58', N'Đơn', N'F03', 0, N'P01', 1,N'LC01'),
(N'G59', N'Đơn', N'F04', 0, N'P01', 1,N'LC01'), 
(N'G60', N'Đơn', N'F05', 0, N'P01', 1,N'LC01'), 
(N'G61', N'Đơn', N'F06', 0, N'P01', 1,N'LC01'),
(N'G62', N'Đơn', N'F07', 0, N'P01', 1,N'LC01'), 
(N'G63', N'Đơn', N'F08', 0, N'P01', 1,N'LC01'), 
(N'G64', N'Đơn', N'F09', 0, N'P01', 1,N'LC01'),
(N'G65', N'Đơn', N'F10', 0, N'P01', 1,N'LC01'), 
(N'G66', N'Đơn', N'F11', 0, N'P01', 1,N'LC01'),
(N'G67', N'Đơn', N'G01', 0, N'P01', 1,N'LC01'), 
(N'G68', N'Đơn', N'G02', 0, N'P01', 1,N'LC01'), 
(N'G69', N'Đơn', N'G03', 0, N'P01', 1,N'LC01'),
(N'G70', N'Đơn', N'G04', 0, N'P01', 1,N'LC01'), 
(N'G71', N'Đơn', N'G05', 0, N'P01', 1,N'LC01'), 
(N'G72', N'Đơn', N'G06', 0, N'P01', 1,N'LC01'),
(N'G73', N'Đơn', N'G07', 0, N'P01', 1,N'LC01'), 
(N'G74', N'Đơn', N'G08', 0, N'P01', 1,N'LC01'), 
(N'G75', N'Đơn', N'G09', 0, N'P01', 1,N'LC01'),
(N'G76', N'Đơn', N'G10', 0, N'P01', 1,N'LC01'), 
(N'G77', N'Đơn', N'G11', 0, N'P01', 1,N'LC01'),
(N'G78', N'Đơn', N'H01', 0, N'P01', 1,N'LC01'), 
(N'G79', N'Đơn', N'H02', 0, N'P01', 1,N'LC01'), 
(N'G80', N'Đơn', N'H03', 0, N'P01', 1,N'LC01'),
(N'G81', N'Đơn', N'H04', 0, N'P01', 1,N'LC01'), 
(N'G82', N'Đơn', N'H05', 0, N'P01', 1,N'LC01'), 
(N'G83', N'Đơn', N'H06', 0, N'P01', 1,N'LC01'),
(N'G84', N'Đơn', N'H07', 0, N'P01', 1,N'LC01'), 
(N'G85', N'Đơn', N'H08', 0, N'P01', 1,N'LC01'), 
(N'G86', N'Đơn', N'H09', 0, N'P01', 1,N'LC01'),
(N'G87', N'Đơn', N'H10', 0, N'P01', 1,N'LC01'), 
(N'G88', N'Đơn', N'H11', 0, N'P01', 1,N'LC01'),
(N'G89', N'Đơn', N'I01', 0, N'P01', 1,N'LC01'), 
(N'G90', N'Đơn', N'I02', 0, N'P01', 1,N'LC01'), 
(N'G91', N'Đơn', N'I03', 0, N'P01', 1,N'LC01'),
(N'G92', N'Đơn', N'I04', 0, N'P01', 1,N'LC01'), 
(N'G93', N'Đơn', N'I05', 0, N'P01', 1,N'LC01'), 
(N'G94', N'Đơn', N'I06', 0, N'P01', 1,N'LC01'),
(N'G95', N'Đơn', N'I07', 0, N'P01', 1,N'LC01'), 
(N'G96', N'Đơn', N'I08', 0, N'P01', 1,N'LC01'), 
(N'G97', N'Đơn', N'I09', 0, N'P01', 1,N'LC01'),
(N'G98', N'Đơn', N'I10', 0, N'P01', 1,N'LC01'), 
(N'G99', N'Đơn', N'I11', 0, N'P01', 1,N'LC01'),
(N'G100', N'Đôi', N'K01', 100, N'P01', 1,N'LC01'), 
(N'G101', N'Đôi', N'K02', 100, N'P01', 1,N'LC01'), 
(N'G102', N'Đôi', N'K03', 100, N'P01', 1,N'LC01'),
(N'G103', N'Đôi', N'K04', 100, N'P01', 1,N'LC01'), 
(N'G104', N'Đôi', N'K05', 100, N'P01', 1,N'LC01'), 
(N'G105', N'Đôi', N'K06', 100, N'P01', 1,N'LC01');
----Phong02
...
(N'HD06','2024-10-27',280000,30000 ,250000,N'P02',N'P04',N'G44',5   ,2,NULL),
(N'HD07','2024-10-26',300000,50000 ,50000 ,N'P05',N'P06',N'G88' ,NULL,6,NULL),
(N'HD08','2024-10-28',325000,0     ,325000,N'P06',N'P02',N'G37',5   ,2,NULL),
(N'HD09','2024-10-29',250000,25000 ,225000,N'P01',N'P03',N'G12',NULL,1,NULL),
(N'HD10','2024-11-30',275000,0     ,275000,N'P02',N'P01',N'G92' ,NULL,3,NULL),
(N'HD11','2024-10-30',150000,0     ,150000,N'P03',N'P02',N'G47',NULL,2,NULL),
(N'HD12','2024-10-30',100000,0     ,100000,N'P04',N'P06',N'G08',4   ,1,NULL),
...
(N'HD15','2024-10-30',150000,0     ,150000,N'P01',N'P05',N'G12',NULL,5,NULL),
(N'HD16','2024-10-30',250000,0     ,250000,N'P02',N'P05',N'G29',4   ,2,NULL),
(N'HD17','2024-10-30',150000,0     ,150000,N'P03',N'P03',N'G54',5   ,2,NULL),
(N'HD18','2024-10-30',200000,25000 ,175000,N'P05',N'P02',N'G09',NULL,3,NULL),
(N'HD19','2024-10-30',300000,50000 ,250000,N'P04',N'P01',N'G01',NULL,2,NULL),
(N'HD20','2024-10-30',500000,230000,270000,N'P06',N'P04',N'G10',3   ,4,NULL);
