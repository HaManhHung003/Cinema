...
public class GUI_Man_hinh_chinh extends JFrame{
	...
	private GUI_ThongKe statisticPanel;
	private GUI_KhachHang customerPanel;
	...
	public GUI_Man_hinh_chinh() throws FontFormatException, IOException {
		...
		customer_pnl.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
            	customerPanel = new GUI_KhachHang();
        		inform_pnl.add(customerPanel, "customerPanel");
            	cardLayout.show(inform_pnl, "customerPanel");
                help_title.setText("");
                customer_pnl.setColor(new Color(171, 27, 27));
                home_pnl.setColor(black);
                bookTicket_pnl.setColor(black);
                sale_pnl.setColor(black);
                staff_pnl.setColor(black);
		...
		statistic_pnl.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
            	statisticPanel = new GUI_ThongKe();
        		inform_pnl.add(statisticPanel, "statisticPanel");
            	cardLayout.show(inform_pnl, "statisticPanel");
                help_title.setText("");
                statistic_pnl.setColor(new Color(171, 27, 27));
                home_pnl.setColor(black);
                bookTicket_pnl.setColor(black);
                sale_pnl.setColor(black);
                staff_pnl.setColor(black);
