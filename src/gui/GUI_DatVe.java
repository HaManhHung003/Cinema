...
public class GUI_DatVe extends JPanel{
	...
	public GUI_DatVe(GUI_Man_hinh_chinh man_hinh) throws FontFormatException, IOException {
		...
		theloai_phim2.setText(tenPhim2);
		...
		tieude_phim2.setText("Thể loại : "+theLoai2+"\nThời lượng :  "+thoiLuong2+" phút");
		...
		theloai_phim3.setText(tenPhim6);
		...
		tieude_phim3.setText("Thể loại : "+theLoai6+"\nThời lượng :  "+thoiLuong6+" phút");
		...
		theloai_phim4.setText(tenPhim3);
		...
		tieude_phim4.setText("Thể loại : "+theLoai3+"\nThời lượng :  "+thoiLuong3+" phút");
