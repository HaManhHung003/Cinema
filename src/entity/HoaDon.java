...
//	}
	...
	@Override
	public String toString() {
		return "HoaDon [maHD=" + maHD + ", ngayLapHD=" + ngayLapHD + ", thoiGianLapHD=" + thoiGianLapHD + ", tongTien="
				+ tongTien + ", phong=" + phong + ", phim=" + phim + ", maGiamGia=" + maGiamGia + ", IDKH=" + IDKH
				+ ", IDNV=" + IDNV + "]";
	}
...
public HoaDon(String maHD, LocalDateTime ngayLapHD, Time thoiGianLapHD, double tongTien, Phong phong, Phim phim,
			MaGiamGia maGiamGia, String iDKH, String iDNV) {
		super();
		this.maHD = maHD;
		this.ngayLapHD = ngayLapHD;
		this.thoiGianLapHD = thoiGianLapHD;
